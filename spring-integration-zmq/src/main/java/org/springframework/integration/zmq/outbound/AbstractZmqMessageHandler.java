 ...
 *
 */
public abstract class AbstractZmqMessageHandler extends AbstractMessageHandler implements Lifecycle {
	...
	private int clientType = ZMQ.REP;

	public AbstractZmqMessageHandler(String url, String clientId) {
	...
	public String getComponentType() {
		return "zmq:outbound-channel-adapter";
	}
	...
	protected void onInit() throws Exception {
		...
		if (this.converter == null) {
			DefaultZmqMessageConverter defaultConverter = new DefaultZmqMessageConverter();
