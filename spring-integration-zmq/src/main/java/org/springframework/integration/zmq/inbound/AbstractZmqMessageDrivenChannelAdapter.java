...
public abstract class AbstractZmqMessageDrivenChannelAdapter extends MessageProducerSupport {
	...
	private volatile ZmqMessageConverter converter;

	protected final Lock topicLock = new ReentrantLock();

	public AbstractZmqMessageDrivenChannelAdapter(String url, String clientId) {
		Assert.hasText(clientId, "'clientId' cannot be null or empty");
		this.url = url;
		this.clientId = clientId;
	}

	public void setConverter(ZmqMessageConverter converter) {
	...
	protected ZmqMessageConverter getConverter() {
	...
	public String getComponentType() {
		return "zmq:inbound-channel-adapter";
	}
	...
	protected void onInit() {
		...
		if (this.converter == null) {
			DefaultZmqMessageConverter zmqMessageConverter = new DefaultZmqMessageConverter();
