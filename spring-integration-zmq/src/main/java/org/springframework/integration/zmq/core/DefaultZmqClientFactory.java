 ...
 *
 */
public class DefaultZmqClientFactory implements ZmqClientFactory {
	...
	public ZMQ.Socket getClientInstance(String clientId, String... topic) {
		...
		if (this.getUserName() != null && this.getPassword() != null) {
			this.client = getZContext().createSocket(this.clientType);
		}
		else {
			this.client = this.context.socket(this.clientType);
		}
