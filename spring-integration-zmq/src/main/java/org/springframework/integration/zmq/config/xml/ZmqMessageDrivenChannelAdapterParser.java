 ...
 *
 */
public class ZmqMessageDrivenChannelAdapterParser extends AbstractChannelAdapterParser {

	@Override
	protected AbstractBeanDefinition doParse(Element element, ParserContext parserContext, String channelName) {

		BeanDefinitionBuilder builder = BeanDefinitionBuilder
				.genericBeanDefinition(ZmqMessageDrivenChannelAdapter.class);

		ZmqParserUtils.parseCommon(element, builder, parserContext);
