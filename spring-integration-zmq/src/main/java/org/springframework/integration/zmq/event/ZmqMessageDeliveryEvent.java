...
public abstract class ZmqMessageDeliveryEvent extends ZmqIntegrationEvent {
	...
	public ZmqMessageDeliveryEvent(Object source, String clientId,
								int clientType, String topic) {
		super(source);
