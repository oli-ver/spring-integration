...
package org.springframework.integration.zmq.support;
 ...
 *
 */
public class DefaultZmqMessageConverter implements ZmqMessageConverter, BeanFactoryAware {
	 ...
	 */
	public DefaultZmqMessageConverter() {
		this("UTF-8");
	}
	 ...
	 */
	public DefaultZmqMessageConverter(String charset) {
	...
	public Message<?> toMessage(Object zmqMessage, MessageHeaders headers) {
		Assert.isInstanceOf(byte[].class, zmqMessage,
				() -> "This converter can only convert an 'ZmqMessage'; received: "
						+ byte[].class.getName());
